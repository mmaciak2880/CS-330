...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// this callback is use to receive mouse scroll wheel events
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	{
		// change to a 3-D perspective
		bOrthographicProjection = false;

		// change the camera settings to show a 3-D view
		g_pCamera->Position = glm::vec3(0.0f, 15.0f, 10.0f);
		g_pCamera->Up = glm::vec3(0.0f, 1.0f, 0.0f);
